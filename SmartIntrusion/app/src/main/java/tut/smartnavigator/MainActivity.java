...
public class MainActivity extends AppCompatActivity {
    ...
    String videoURL = "http://172.20.10.3:8081/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServoDown = (Button) findViewById(R.id.btn_servo_Down);
        ServoUp = (Button) findViewById(R.id.btn_Servo_Up);
        ServoLeft = (Button) findViewById(R.id.btn_servo_left);
        ServoRight = (Button) findViewById(R.id.btn_servo_right);
        stopControl = (Button) findViewById(R.id.btn_stop);
    ...
    public void init(){
        ...
        Button googleMaps = (Button) findViewById(R.id.btn_googleMaps);
    ...
    {
        String iPandPort = "172.20.10.3:21567";
